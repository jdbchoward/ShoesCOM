...
public class TestShoesSearchUS {
	...
	@Test
	public void testShoesSearchUS() throws Exception {

		boolean searchResult = false;
		boolean urlRef = false;
		testOperation.doSignInUSsite("hiend@yeah.net", "10011001");
		wait.threadWait(waitTimes);
		searchResult = testOperation.searchShoeUS();
		wait.threadWait(waitTimes);
		log.debug("current URL is : "+driver.getCurrentUrl());
		urlRef = driver.getCurrentUrl().contains("moab-ventilator,mens-search");
